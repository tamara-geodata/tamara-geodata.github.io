...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 22, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            //extent: [366893.762700, 5044913.007100, 404401.324000, 5064005.338300],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([380403.059375, 5050328.137500, 397205.159375, 5060129.362500], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mappa dei percorsi del Parco Mont Avic</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (763 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Il Parco Naturale Mont Avic è stato istituito nel 1989 per preservare una delle aree più selvagge della regione: l’alto bacino del torrente Chalamy in comune di Champdepraz.<br />La flora e la vegetazione del Parco sono profondamente influenzate dalla presenza di un gran numero di laghi e piccole zone umide, nonché di abbondanti affioramenti di serpentiniti, rocce che danno origine a suoli poveri e poco profondi. La fauna del Parco, invece, è caratterizzata in primo luogo dall’elevato numero di specie di insetti presenti, dovuto alla notevole varietà ambientale dell’area protetta.<br />Questa mappa vuole riportare alcuni dei più importanti percorsi escursionisti che attraversano questo parco situato in Valle d\'Aosta.<br />Sito ufficiale del parco: https://montavic.it/';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_PercorsiescursionisticiMontAvic_3,
    colName: 'Nome',
    zoom: 10,
    collapsed: true,
    map: map,
